...
def get_optim(model_, score_rgs, diff_rgs, args, optim_id=1):
    """
    Keep the original graph-related parameter groups as much as possible,
    while also covering the ST-GCN-only input-adaptation modules.
    """
    optimizer = optim.Adam(
        [
            ...
            {'params': model_.module.stgcn_encoder.parameters(), 'weight_decay': args.weight_decay},
            {'params': model_.module.stgcn_diff_encoder.parameters(), 'weight_decay': args.weight_decay},
            ...
            {'params': model_.module.token_projector.parameters(), 'weight_decay': args.weight_decay},
            {'params': model_.module.token_norm.parameters(), 'weight_decay': args.weight_decay},
    ...
    if optim_id == 1:
        ...
        raise ValueError(f'Unknown optim_id: {optim_id}')
