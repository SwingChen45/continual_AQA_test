...
```
python Exp_AQA7/run_net.py --exp_name your_exp_name \
  --gpu 0 --seed 0 --approach g_e_graph \
...
```
```
python Continual-AQA-main/Exp_FisV/run_net.py --exp_name FisV_balance_tes_ms60 \
  --gpu 0 --seed 0 --approach g_e_graph \
  --lambda_distill 9 --lambda_diff 0.7 \
  --replay --replay_method group_replay --memory_size 30 \
  --fisv_root /home/administrator/exp--fs-aug/Continual-AQA-main/DATA/FisV \
  --diff_loss --dataset_name fisv --score_type TES \
  --aug_approach aug-diff --aug_mode fs_aug --num_helpers 7 --aug_scale 0.3\
  --save_graph --g_e_graph --fix_graph_mode no_fix \
  --save_ckpt\
  --optim_mode new_optim --lr_decay --num_epochs 200 --batch-size 16 --alpha 0.8
