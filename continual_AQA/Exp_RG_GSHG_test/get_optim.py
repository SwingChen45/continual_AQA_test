...
def get_optim(model_, score_rgs, diff_rgs, args, optim_id=1):
    ...
    if hasattr(net, 'gshg'):
        optimizer = optim.Adam(
            [
                {'params': [net.gshg.hyper_edge_weight_gen], 'weight_decay': 0, 'lr': 0.01},
                {'params': [net.gshg.hyper_edge_weight_spec], 'weight_decay': 0, 'lr': 0.01},
                {'params': [net.gshg.hyper_alpha], 'weight_decay': 0, 'lr': args.base_lr * args.lr_factor},
                {'params': [net.gshg.edge_importance], 'weight_decay': 0, 'lr': args.base_lr * args.lr_factor},
                {'params': [net.gshg.hyper_joint], 'weight_decay': args.weight_decay},
                {'params': net.gshg.to_V.parameters(), 'weight_decay': args.weight_decay},
                {'params': net.gshg.to_W.parameters(), 'weight_decay': args.weight_decay},
